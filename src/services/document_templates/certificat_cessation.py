"""
========================================================================
Template : Certificat de Cessation de Service
========================================================================
Document qui certifie qu'un agent a cessé ses fonctions à un poste.
Utilisé lors de : mutation, retraite, démission, fin de détachement,
réorientation, décès.

Structure :
1. Préambule : "Le DR ... certifie par la présente que :"
2. Tableau infos agent (Civilité, Matricule, Emploi, Grade, Fonction)
3. Phrase officielle : "A cessé ses fonctions au ... en qualité de ...,
   le ..., pour motif de ..."
...
# ========================================================================
class CertificatCessationTemplate(DocumentTemplate):
    """Template du Certificat de Cessation de Service."""

    type_document = "certificat_cessation"
    titre_document = "CERTIFICAT DE CESSATION DE SERVICE"
    dossier_sortie = "certificats_cessation"
    destinataire = []
    ...
    def build_body(self, context: dict, styles: dict) -> list:
        ...
        elements.append(Paragraph(
            ...
            f"en qualité de <b>{qualite}</b>, "
            f"le <b>{date_cessation_str}</b>, "
            f"pour motif de <b>{motif}</b>.",
            styles["body"]
        ))
        elements.append(Spacer(1, 0.3 * cm))
